...
public class FullScreenQuadRenderer {
	...
	private VertexArrayCache.VertexArray vertexArray;
	...
	public void bind() {
		vertexArray = ((GlDevice) ((GpuDeviceAccessor) RenderSystem.getDevice()).getBackend()).vertexArrayCache().bindVertexArray(new com.mojang.blaze3d.vertex.VertexFormat[]{DefaultVertexFormat.POSITION_TEX}, new GpuBufferSlice[]{quad.slice()}, vertexArray);
	}
}

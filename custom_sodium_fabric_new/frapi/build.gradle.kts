...
dependencies {
    ...
    implementation("net.fabricmc.fabric-api:fabric-renderer-api-v1:13.0.4+c80601bb4c")
    include("net.fabricmc.fabric-api:fabric-renderer-api-v1:13.0.4+c80601bb4c")
}

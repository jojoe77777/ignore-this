...
public class TerrainRenderPass {
    ...
    public RenderTarget getTarget() {
        ...
        var translucentTarget = client.levelRenderer.translucentTarget();
        return (isTranslucent && translucentTarget != null) ? translucentTarget : client.gameRenderer.mainRenderTarget();
    }

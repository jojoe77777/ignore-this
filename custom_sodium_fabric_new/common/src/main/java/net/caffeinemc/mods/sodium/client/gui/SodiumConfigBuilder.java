                        ...
                        builder.createEnumOption(Identifier.parse("sodium:quality.clouds"), CloudStatus.class)
                                ...
                                .setBinding((value) -> {
                                    this.vanillaOpts.cloudStatus().set(value);
                                                                        ...
                                                                        if (framebuffer != null) {
                                                                                RenderSystem.getDevice().createCommandEncoder().clearColorAndDepthTextures(framebuffer.getColorTexture(), new Vector4f(1.0F, 1.0F, 1.0F, 1.0F), framebuffer.getDepthTexture(), 1.0f);
                                    }

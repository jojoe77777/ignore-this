...
public abstract class ShaderChunkRenderer implements ChunkRenderer {
    ...
    protected void begin(TerrainRenderPass pass, FogParameters parameters, GpuSampler terrainSampler) {
        ...
        GlDevice glDevice = (GlDevice) ((GpuDeviceAccessor) RenderSystem.getDevice()).sodium$getBackend();
        int framebuffer = glDevice.frameBufferCache().getFbo(glDevice.directStateAccess(), List.of((FrameBufferAttachment) target.getColorTexture()), (FrameBufferAttachment) target.getDepthTexture());

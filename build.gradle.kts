...
val SODIUM_DEPENDENCY_FABRIC by extra { files(rootDir.resolve("custom_sodium_fabric").resolve("build").resolve("mods").resolve("sodium-fabric-0.8.12-SNAPSHOT+mc26.2-local.jar")) }

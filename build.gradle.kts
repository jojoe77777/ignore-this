...
val MINECRAFT_VERSION by extra { "26.2-pre-1" }
val NEOFORGE_VERSION by extra { "26.1.1.0-beta" }
val FABRIC_LOADER_VERSION by extra { "0.19.2" }
val FABRIC_API_VERSION by extra { "0.149.2+26.2" }

val SODIUM_DEPENDENCY_FABRIC by extra { files(rootDir.resolve("custom_sodium_fabric").resolve("build").resolve("mods").resolve("sodium-fabric-0.8.12-SNAPSHOT+mc26.2-pre-1-local.jar")) }
